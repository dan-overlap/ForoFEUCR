...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { amount_comments: @discussion.amount_comments, comments_id: @discussion.comments_id } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { amount_comments: @discussion.amount_comments, comments_id: @discussion.comments_id } }
